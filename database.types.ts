  ...
  public: {
    Tables: {
      ...
      posts_upvotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "posts_upvotes_post_id_posts_post_id_fk"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "community_post_list_view"
            referencedColumns: ["post_id"]
          ...
          {
            foreignKeyName: "posts_upvotes_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
    ...
    Enums: {
      ...
      notification_type: "follow" | "reviews" | "reply" | "mention"
