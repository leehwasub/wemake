...
CREATE TABLE "posts_upvotes" (
	"post_id" bigint,
	"profile_id" uuid,
	CONSTRAINT "posts_upvotes_post_id_profile_id_pk" PRIMARY KEY("post_id","profile_id")
);
--> statement-breakpoint
CREATE TABLE "topics" (
...
ALTER TABLE "posts_upvotes" ADD CONSTRAINT "posts_upvotes_post_id_posts_post_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("post_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "posts_upvotes" ADD CONSTRAINT "posts_upvotes_profile_id_profiles_profile_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;